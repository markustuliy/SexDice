...
public class SexRoulette extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            tasksMediumListWoman.add("Возьми ленточку или шнурок, обвяжи им яички у самого основания мошонки. Не затягивать узел слишком сильно. После этого она играет с яичками перышком или кисточкой для макияжа");
